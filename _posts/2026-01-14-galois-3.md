...
## Method of Lagrange Resolvents
Here is a summary of what we know so far:
1. Solving polynomials can be studied in terms of solving the Lagrange Resolvent Polynomial.
2. For $n=2$, and $3$, the resolvent polynomial can be directly solved. Solving the resolvent polynomial, helps us find the roots of the original polynomial.
3. For $n=4$, the Lagrange Resolvent polynomial can not be directly solved. However, by solving an auxilary polynomial, we can factorize the resolvent polynomial. We can solve the resolvent polynomial fully. Solving the resolvent polynomial, helps us find the roots of the original polynomial.
4. We can use Lagrange Resolvent to solve for primitive roots of unity. 
