...
This shows that for any root $t_1$ of $g$, the root permutation $(r_1,r_2,\ldots,r_n) = (\phi_1(t),\phi_2(t),\ldots,\phi_n(t)) \to (\phi_1(t'),\phi_2(t'),\ldots,\phi_n(t'))$ maps $t_1 \to t_2$ where $t_2$ is another root of $g$.
