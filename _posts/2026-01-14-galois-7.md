...
---
# Table of Contents
This is Part 7 out of the 8 part series on Galois Theory. 

To navigate to any other part, click on the corresponding link below.
 - [Part 1: Prerequisites](galois-1.html)
 - [Part 2: Solving Polynomials upto degree 4](galois-2.html)
 - [Part 3: Lagrange Resolvent](galois-3.html)
 - [Part 4: Fields](galois-4.html)
 - [Part 5: Root Permutations](galois-5.html)
 - [Part 6: Groups](galois-6.html)
 - [Part 7: Factorization of the Resolvent Polynomial](galois-7.html)
 - [Part 8: Solvability](galois-8.html)
...
$$U(x, \alpha^2 r) = V(x,\alpha^2 r)W(x,\alpha^2 r)$$
...
$$g(x) = h(x,\alpha^2 r)q(x,\alpha^2 r)$$
